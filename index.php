...
if(isset($_POST['see_prod'])){
  session_start();
  $_SESSION['produc_index'] = $_POST['id_prod_prod'];
  echo "producto: " . $_SESSION['prod_bill_index'];  
  header('location:index_cart_prod_sample.php');
};
  ...
  <div class="box-container">
    ...
    if (mysqli_num_rows($select_products)>0) {
      ...
      ?>
        ...
        <input type="hidden" name="id_prod_prod" value="<?= $fetch_products['id_prod']; ?>">
