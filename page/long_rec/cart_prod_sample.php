...
?>
    ...
    $produc_cart_2=$_SESSION['prod_bill'];
    $select_products_sc_2= mysqli_query($conn,"SELECT * FROM `producto` WHERE id_prod='$produc_cart_2'") or die ("busqueda de productos fallada");
